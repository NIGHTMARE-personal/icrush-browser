...
const electronAPI = {
    ...
    agent: {
        ...
        startLoop: (goal, context) => electron_1.ipcRenderer.invoke('agent:start', { goal, context: context || '' }),
        cancelLoop: () => electron_1.ipcRenderer.invoke('agent:cancel'),
        getProgress: () => electron_1.ipcRenderer.invoke('agent:get-progress'),
        undoLoop: () => electron_1.ipcRenderer.invoke('agent:undo'),
        toolList: () => electron_1.ipcRenderer.invoke('agent:tool-list'),
        toolExecute: (toolId, params) => electron_1.ipcRenderer.invoke('agent:tool-execute', toolId, params),
        sandboxState: () => electron_1.ipcRenderer.invoke('agent:sandbox-state'),
        sandboxKillSwitch: (enable) => electron_1.ipcRenderer.invoke('agent:sandbox-kill-switch', enable),
        crossTabCompare: (tabIdA, tabIdB) => electron_1.ipcRenderer.invoke('agent:cross-tab-compare', tabIdA, tabIdB),
        crossTabMerge: (tabIds) => electron_1.ipcRenderer.invoke('agent:cross-tab-merge', tabIds),
        memoryStats: () => electron_1.ipcRenderer.invoke('agent:memory-stats'),
        memoryCompact: () => electron_1.ipcRenderer.invoke('agent:memory-compact'),
        routerState: () => electron_1.ipcRenderer.invoke('agent:router-state'),
        routerConsent: (provider) => electron_1.ipcRenderer.invoke('agent:router-consent', provider),
        routerRevoke: (provider) => electron_1.ipcRenderer.invoke('agent:router-revoke', provider),
        identityList: () => electron_1.ipcRenderer.invoke('agent:identity-list'),
        identityCreate: (name) => electron_1.ipcRenderer.invoke('agent:identity-create', name),
        identityRemove: (credentialId) => electron_1.ipcRenderer.invoke('agent:identity-remove', credentialId),
        getApiKey: (provider) => electron_1.ipcRenderer.invoke('agent:get-api-key', provider),
        setApiKey: (provider, key) => electron_1.ipcRenderer.invoke('agent:set-api-key', provider, key),
    },
    mcp: {
