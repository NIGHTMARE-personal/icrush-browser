...
class DOMEngine {
    constructor(executeJs, webviewId, config) {
        ...
        Object.defineProperty(this, "webviewId", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "mutationObserverActive", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
    ...
    async execute(action, options = {}) {
        ...
        const jsCode = (0, agent_engine_1.generateActionJS)(action);
        let lastError;
    ...
    async detectSensitiveFields() {
        const js = (0, agent_engine_1.generateSensitiveFieldDetectionJS)();
        const result = await this.executeJS(js);
        try {
     ...
     */
    async showHighlight(selector, color, duration) {
        const js = (0, agent_engine_1.generateHighlightJS)(selector, color, duration);
        await this.executeJS(js);
    }
    /**
     * Show a tooltip near an element.
     */
    async showTooltip(selector, text, color) {
        const js = (0, agent_engine_1.generateTooltipJS)(selector, text, color);
        await this.executeJS(js);
    }
    // ─── Utility ────────────────────────────────────────────────────────
    parseResult(raw) {
    ...
    async executeWithTimeout(code, ms) {
